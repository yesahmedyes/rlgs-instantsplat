...
class RLGSConfig:
    ...
    def __post_init__(self):
        if self.lr_groups is None:
            self.lr_groups = ["xyz", "f_dc", "opacity", "scaling", "rotation"]
...
def add_rlgs_args(parser):
    ...
    group.add_argument("--rlgs_reshuffle_interval", type=int, default=1000, help="Reward view reshuffle interval")
...
def create_rlgs_config_from_args(args) -> RLGSConfig:
    ...
    return RLGSConfig(
        ...
        reshuffle_interval=getattr(args, "rlgs_reshuffle_interval", 1000),
    )
